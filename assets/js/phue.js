...
function RGBtoXY(red, green, blue, model) {
	...
	var Z = red * 0.0 + green * 0.053077 + blue * 1.035763;
...
function XYtoRGB(x, y, brightness, model) {
	...
	var r = X * 3.241 - Y * 1.5374 - Z * 0.4986;
	var g = -X * 0.9692 + Y * 1.876 + Z * 0.0416;
	var b = X * 0.0556 - Y * 0.204 + Z * 1.057;
